...
public class HBaseUtil {
    ...
    public static Result getRow(String tableName, String rowkey, FilterList filterList){
        try( Table table = HBaseConn.getTable(tableName)){
            ...
            System.out.println("info:student_id == "+Bytes.toString(result.getValue(Bytes.toBytes("info"), Bytes.toBytes("G001"))));
            System.out.println("info:class == "+Bytes.toString(result.getValue(Bytes.toBytes("info"), Bytes.toBytes("3"))));
            System.out.println("score:understanding == "+Bytes.toString(result.getValue(Bytes.toBytes("score"), Bytes.toBytes("80"))));
            System.out.println("score:programming == "+Bytes.toString(result.getValue(Bytes.toBytes("score"), Bytes.toBytes("80"))));
